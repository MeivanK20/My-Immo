...
const AdminDashboardPage: React.FC<AdminDashboardPageProps> = ({ allUsers, allProperties, onNavigate, onDeleteUser, onDeleteProperty }) => {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <h1 className="text-3xl font-bold text-brand-dark mb-6">{t('adminDashboardPage.title')}</h1>
      ...
      <div className="border-b border-gray-200 mb-8">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          ...
          <button
            ...
            className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'properties' ? activeTabClasses : inactiveTabClasses}`}
          >
      ...
      {activeTab === 'users' && (
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <h2 className="text-xl font-semibold">{t('adminDashboardPage.userManagement')}</h2>
          </div>
      ...
      {activeTab === 'properties' && (
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <h2 className="text-xl font-semibold">{t('adminDashboardPage.propertyManagement')}</h2>
          </div>
          <div className="overflow-x-auto">
