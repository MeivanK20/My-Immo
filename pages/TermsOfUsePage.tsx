    ...
    <div className="bg-brand-dark">
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose lg:prose-lg max-w-none text-gray-300 prose-headings:text-white prose-strong:text-white space-y-6">
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 1 : Objet</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 2 : Accès et Inscription</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 3 : Obligations des Annonceurs</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 4 : Responsabilité</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 5 : Propriété Intellectuelle</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 6 : Modification des CGU</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">Article 7 : Droit applicable</h2>
          <p>
           ...
           <h2 className="text-2xl font-semibold pt-4">Article 8 : Contact</h2>
          <p>
