  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-brand-dark">{t('contactPage.title')}</h1>
        <p className="text-lg text-gray-600 mt-2">{t('contactPage.subtitle')}</p>
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">{t('contactPage.addressValue')}</p>
          </div>
        </div>
        ...
        <div>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-700">{t('contactPage.message')}</label>
                <textarea
                  id="message"
                  name="message"
                  rows={5}
