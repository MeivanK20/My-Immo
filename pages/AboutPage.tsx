    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-lg md:text-xl mt-4">{t('aboutPage.heroSubtitle')}</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-brand-dark mb-2">{t('aboutPage.missionTitle')}</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-brand-dark mb-2">{t('aboutPage.leaderTitle')}</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-brand-dark mb-2">{t('aboutPage.valuesTitle')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-brand-dark mb-2">{t('aboutPage.valueTrust')}</h3>
                <p className="text-gray-600">{t('aboutPage.valueTrustText')}</p>
            </div>
            {/* Value 2: Innovation */}
            <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex justify-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-brand-dark mb-2">{t('aboutPage.valueInnovation')}</h3>
                <p className="text-gray-600">{t('aboutPage.valueInnovationText')}</p>
            </div>
            {/* Value 3: Excellence */}
            <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex justify-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-brand-dark mb-2">{t('aboutPage.valueExcellence')}</h3>
                <p className="text-gray-600">{t('aboutPage.valueExcellenceText')}</p>
            </div>
          </div>
        </div>
      </section>
