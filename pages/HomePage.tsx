    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Trouvez la maison de vos rêves</h1>
          <p className="text-lg md:text-xl mb-8">La meilleure plateforme pour la recherche immobilière au Cameroun.</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-2xl md:flex items-center gap-4 max-w-2xl mx-auto">
            ...
            <Button onClick={handleSearch} className="w-full md:w-auto">Rechercher</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-brand-dark mb-2">Annonces à la une</h2>
