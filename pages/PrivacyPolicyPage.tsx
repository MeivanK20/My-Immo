    ...
    <div className="bg-brand-dark">
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose lg:prose-lg max-w-none text-gray-300 prose-headings:text-white prose-strong:text-white space-y-6">
          ...
          <h2 className="text-2xl font-semibold pt-4">1. Informations que nous collectons</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">2. Comment nous utilisons vos informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">3. Partage de vos informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">4. Sécurité des données</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">5. Vos droits</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold pt-4">6. Modifications de cette politique</h2>
          <p>
